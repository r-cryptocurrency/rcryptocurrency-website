  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-950 text-gray-900 dark:text-white pt-24">
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="flex justify-center mb-8">
          {isConnected ? (
            <div className="flex items-center gap-4">
              <span className="bg-gray-200 dark:bg-gray-800 px-4 py-2 rounded-lg text-sm font-mono">
        ...
        {isConnected && (
          <div className="bg-white dark:bg-gray-900 rounded-xl p-6 space-y-6 shadow-lg dark:shadow-none border border-gray-200 dark:border-gray-800">
            {/* Current Link Status */}
            {checkingStatus ? (
              <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4 text-center">
                <span className="text-gray-600 dark:text-gray-400">Checking link status...</span>
              </div>
            ) : linkStatus?.isLinked ? (
              <div className="bg-green-100 dark:bg-green-900/30 border border-green-500 dark:border-green-600 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  <svg className="w-5 h-5 text-green-600 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-green-700 dark:text-green-400 font-semibold">Address Already Linked</span>
                </div>
                <p className="text-green-800 dark:text-gray-300">
                  This address is linked to <span className="text-orange-600 dark:text-orange-400 font-mono">u/{linkStatus.username}</span>
                </p>
              ...
              <div className="bg-yellow-100 dark:bg-yellow-900/30 border border-yellow-500 dark:border-yellow-600 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  <svg className="w-5 h-5 text-yellow-600 dark:text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                  </svg>
                  <span className="text-yellow-700 dark:text-yellow-400 font-semibold">Different Distribution Address</span>
                </div>
                <p className="text-yellow-800 dark:text-gray-300">
                  Your Reddit account <span className="text-orange-600 dark:text-orange-400 font-mono">u/{linkStatus.username}</span> has a different address linked for distributions.
                </p>
            ...
            <div>
              ...
              <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300">
                <li className="flex flex-wrap items-center gap-2">
                  ...
                  <button
                    onClick={copyAddress}
                    className="relative bg-gray-200 dark:bg-gray-800 px-2 py-1 rounded text-sm text-orange-600 dark:text-orange-400 break-all
                               hover:bg-gray-300 dark:hover:bg-gray-700 cursor-pointer transition-colors"
                    title="Click to copy"
                  >
                    <code>{address}</code>
                    {copied && (
            ...
            <button
              ...
              className="w-full bg-orange-600 hover:bg-orange-500 text-white disabled:bg-gray-300 dark:disabled:bg-gray-700
                         disabled:text-gray-500 dark:disabled:text-gray-400 disabled:cursor-not-allowed py-3 rounded-lg font-semibold
                         transition-colors"
            >
              {status === 'loading' ? (
            ...
            {status === 'success' && result && (
              <div className="bg-green-100 dark:bg-green-900/50 border border-green-500 rounded-lg p-4">
            ...
            {status === 'error' && result?.error && (
              <div className="bg-red-100 dark:bg-red-900/50 border border-red-400 dark:border-red-500 rounded-lg p-4">
