            ...
            <div className="bg-white/80 dark:bg-black/20 backdrop-blur-sm rounded-xl shadow-lg border border-orange-100 dark:border-white/10">
              <div className="relative z-20 bg-orange-100/50 dark:bg-white/5 px-6 py-4 border-b border-orange-100 dark:border-white/10 flex justify-between items-center rounded-t-xl">
                ...
                <div className="flex gap-2">
                  <Link href="/stats?range=24h" className={`text-xs px-2 py-1 rounded ${range === '24h' ? 'bg-rcc-orange text-white' : 'bg-white/50 dark:bg-white/10 text-slate-600 dark:text-slate-400 hover:bg-rcc-orange/20'}`}>24h</Link>
                  <Link href="/stats?range=7d" className={`text-xs px-2 py-1 rounded ${range === '7d' ? 'bg-rcc-orange text-white' : 'bg-white/50 dark:bg-white/10 text-slate-600 dark:text-slate-400 hover:bg-rcc-orange/20'}`}>7d</Link>
                  <Link href="/stats?range=30d" className={`text-xs px-2 py-1 rounded ${range === '30d' ? 'bg-rcc-orange text-white' : 'bg-white/50 dark:bg-white/10 text-slate-600 dark:text-slate-400 hover:bg-rcc-orange/20'}`}>30d</Link>
                </div>
              </div>
              <div className="p-6">
