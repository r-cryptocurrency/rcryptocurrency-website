...
// Heroicons use ForwardRefExoticComponent, so we need to accept that type
...
// Reddit icon as inline SVG component
  ...
  external: [
    {
      ...
      icon: RedditIcon,
      external: true,
      ariaLabel: 'Visit r/CryptoCurrency subreddit (opens in new tab)',
    },
  ],
};
